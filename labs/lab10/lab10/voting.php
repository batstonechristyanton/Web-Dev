  ...
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
      ...
      <script>window.jQuery || document.write('<script src="js/jquery.js"><\/script>');</script>
        <!--Example My javascript - Relative Path -->
      <script src="js/script.js"></script>

    <title>Lab 10 - Voting</title>
  </head>
  ...
  <body>
    <div id="container">
      <?php include "header.php"; ?>
        <div id="content">
        <div id="ajaxmessage"></div>  <!-- use this div for your ajax status message-->
          <form id="nomination" action="processnomination.php" method="post" novalidate>
            <div>

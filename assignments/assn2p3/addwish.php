...
$query = "insert into gclWish (fk_userID, wish, priority, wishDesc, weblink,filepath,bought) values (?,?,?,?,?,?,?)";
$type='isisssi'; 

    //create parameter array
$params= array(&$fk_userID, &$item, &$priority, &$wishDesc,&$link,&$wishimage,&$purchased);
    //run query
